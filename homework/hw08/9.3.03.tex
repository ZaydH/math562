...
The $F$\=/table does not have values for ${n=m=20}$ so ${n=m=21}$ is used. ${F_{0.025,20,20} = 0.406}$ and ${F_{0.975,20,20} = 2.46}$\text{.}  ${\frac{S^{2}_{X}}{S^{2}_{Y}} = \frac{3.524}{2.411} = 1.416}$.  Since ${F_{0.025,20,20} < \frac{S^{2}_{X}}{S^{2}_{Y}} < F_{0.975,20,20}}$ so the hypothesis is \text{not rejected}.
