\begin{problem}
  \probNum{6.5.02} Let ${y_1,y_2,\ldots,y_{10}}$ be a random sample from an exponential pdf with unknown parameter~$\lambda$. Find the form of the GLRT for $H_0$: ${\lambda = \lambda_0}$ versus ${H_1}$: ${\lambda \ne \lambda_0}$.  What integral would have to be evaluated to determine the critical value if~$\alpha$ were equal to~0.05.
\end{problem}
