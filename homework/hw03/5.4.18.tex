\begin{problem}
  \probNum{5.4.18}~Suppose that ${n = 5}$ observations are taken from the uniform pdf ${f_{Y}(y;\theta) = 1/\theta, 0 \leq y \leq \theta}$ where $\theta$~is unknown.  Two biased estimators for $\theta$~are:
  \begin{equation*}
